...
--
-- Name: gend_info; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.gend_info (
    "Gender information:" character varying(255) NOT NULL
);


ALTER TABLE public.gend_info OWNER TO postgres;
...
--
-- Data for Name: gend_info; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.gend_info ("Gender information:") FROM stdin;
We have 3 girls!
We have 3 boys!
\.
...
COPY public.info (info) FROM stdin;
This isVasya,hehas emailmmm@mmail.com
This isAlex,hehas emailmmm@gmail.com
This isAlexey,hehas emailalexey@gmail.com
This isHelen,shehas emailhell@gmail.com
This isJenny,shehas emaileachup@gmail.com
This isLora,shehas emailtpicks@gmail.com
\.
...
COPY public.information (info) FROM stdin;
